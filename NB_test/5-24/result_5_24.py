...
# 上报数据源
logPath = r"F:\测试项目\门锁\5-24数据\5-24日志上报数据.xlsx"
dic1 = result.redExcel(logPath, 0)
print('上传数据源\n', dic1)
print('上传数据源总数为：', len(dic1))

# 下发数据源
logPath = r"F:\测试项目\门锁\\5-24数据\\5-24日志下发数据.xlsx"
...
dic3 = []
time = []
with open(r'F:\测试项目\门锁\模拟测试数据.csv', 'r') as myFile:
...
# 保存到本地excel
with pd.ExcelWriter(r'F:\测试项目\门锁\5-24数据\5-24数据对比结果汇总.xlsx') as writer:
