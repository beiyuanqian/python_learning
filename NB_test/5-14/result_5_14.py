...
# 上报数据源
logPath = r"F:\刘小涵\测试项目\门锁\5-14数据\5-14日志上报数据.xlsx"
dic1 = result.redExcel(logPath, 0)
print('上传数据源\n', dic1)
print('上传数据源总数为：', len(dic1))

# 下发数据源
logPath = r"F:\刘小涵\测试项目\门锁\\5-14数据\\5-14日志下发数据.xlsx"
...
# 保存到本地excel
with pd.ExcelWriter(r'F:\刘小涵\测试项目\门锁\5-14数据\5-14数据对比结果汇总.xlsx') as writer:
