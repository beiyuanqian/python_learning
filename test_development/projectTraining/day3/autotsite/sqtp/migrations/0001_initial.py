# Generated by Django 3.2.4 on 2021-07-17 05:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.CharField(default='demo_case.json', max_length=1000, verbose_name='用例文件路径')),
            ],
        ),
        migrations.CreateModel(
            name='Config',
            fields=[
                ...
                ('base_url', models.CharField(blank=True, max_length=512, null=True, verbose_name='IP/域名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.CharField(default='demo_case.json', max_length=1000, verbose_name='用例文件路径')),
                ('config', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='sqtp.config')),
            ],
        ),
        migrations.CreateModel(
            name='Step',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.JSONField(null=True, verbose_name='data参数')),
        ...
        migrations.AddField(
            model_name='case',
            name='suite',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='sqtp.suite'),
        ),
    ]
